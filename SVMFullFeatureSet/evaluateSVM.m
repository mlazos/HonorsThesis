...
parfor i = 1:length(test_inds)
    [~, ~, ~, ~, true_pos(i), total_pos(i), false_pos(i), total_neg(i)] = classifySingleImage(imsegs(test_inds(i)), SVMStruct, classifiers.vert_classifier,classifiers.horz_classifier,segment_density, tileSize, linSVM.Beta);
end
