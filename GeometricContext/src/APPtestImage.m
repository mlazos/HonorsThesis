function [labels, conf_map, maps, pmaps, regionFeatures] = APPtestImage(image, imsegs, ...
    vClassifier, hClassifier, segDensity, tileSize)
...
if isempty(imsegs)
  imsegs = im2superpixels(image, tileSize);
end
...
num_partitions = [0];%[3 4 5 7 9 11 15 20 25]; no longer matters
